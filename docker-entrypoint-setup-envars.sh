...
replace REACT_APP_GITHUB_OWNER "${REACT_APP_GITHUB_OWNER}"
replace REACT_APP_CDN_REPO "${REACT_APP_CDN_REPO}"
replace REACT_APP_APP_REPO "${REACT_APP_APP_REPO}"
replace REACT_APP_CONTENT_REPO "${REACT_APP_CONTENT_REPO}"
replace REACT_APP_AUTH_URL "${REACT_APP_AUTH_URL}"
