...
export const QUESTION_TYPE_FIELDS: Record<QUESTION_TYPES, (keyof AnyQuestion)[]> = {
    ...
    isaacReorderQuestion: ["randomiseItems", "items", "layout"],
    isaacParsonsQuestion: ["randomiseItems", "items", "layout", "disableIndentation"],
...
export const QUESTION_TYPE_DEFAULTS: Partial<Record<QUESTION_TYPES, Partial<AnyQuestion>>> = {
    ...
    isaacReorderQuestion: { randomiseItems: true, layout: siteSpecific(undefined, "expanded") },
    isaacParsonsQuestion: { randomiseItems: true, layout: siteSpecific(undefined, "expanded") },
